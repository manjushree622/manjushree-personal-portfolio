...
export default function Page() {
  ...
  return <main className="site-shell">
    ...
    <section id="certifications" className="section-pad section-dark"><SectionHeading eyebrow="05 / CERTIFICATIONS" title="Milestones along the way."/><div className="cert-grid">{certifications.map(([title,org],i)=><div className="cert-card reveal" key={title}><div className="cert-icon"><Trophy size={18}/></div><div><span className="cert-org">{org}</span><h3>{title}</h3></div><span className="cert-index">0{i+1}</span></div>)}</div><div className="learning-card reveal"><div className="learning-icon"><Sparkles size={21}/></div><div><span className="eyebrow">CURRENTLY LEARNING</span><h3>Studio Course</h3><p>Currently exploring a Studio course to strengthen my technical knowledge and practical development skills.</p></div><span className="progress-badge"><span/> In Progress</span></div></section>
